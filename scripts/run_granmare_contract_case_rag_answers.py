"""Load granmare_contract_all_article_cases.yaml and write RAG answers to CSV (UTF-8)."""
...
_FIXTURE = ROOT / "tests" / "fixtures" / "granmare_contract_all_article_cases.yaml"
_OUT = ROOT / "tests" / "outputs" / "granmare_all_cases_rag_answers.csv"


def main() -> None:
    parser = argparse.ArgumentParser(description="Run granmare contract YAML cases through RAGAnswerer.")
    parser.add_argument(
        "--with-eval-columns",
        action="store_true",
